...
# more than one item to teh print function, separating them with a comma).

imelda = "More Mayhem", "Imelda May", 2011, (
    (1, "Pulling the Rug"), (2, "Psycho"), (3, "Mayhem"), (4, "Kentish Town Waltz"))

album, singer, year, tracks = imelda
print(album)
print(singer)
print(year)
for items in tracks:
    track, name = items
    print("\tThe track number is {0}. The name of the music is {1}".format(track, name))